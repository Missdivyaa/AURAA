          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">{stats.completed}</h3>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">{stats.active}</h3>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">{stats.missed}</h3>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 text-lg border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                    />
                  </div>
                </div>
                <div className="flex space-x-2">
                  <select
                    ...
                    className="px-4 py-3 text-lg border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                  >
          ...
          {loading && (
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-400">Loading reminders...</p>
              </div>
            </motion.div>
          )}
            ...
            >
              {filteredReminders.length > 0 ? (
                  ...
                  {filteredReminders.map((reminder, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md border-l-4 ${getTypeColor(reminder.type)}`}
                      >
                          ...
                          <div className="flex items-center space-x-3 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center space-x-2 mb-1">
                                <h3 className="text-base font-semibold text-gray-900 dark:text-white truncate">{reminder.title}</h3>
                                <StatusIcon className="w-3 h-3 flex-shrink-0" />
                                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getPriorityColor(reminder.priority)} flex-shrink-0`}>
                                  {reminder.priority}
                                </span>
                              </div>
                              <p className="text-sm text-gray-600 dark:text-gray-400 truncate">{reminder.description}</p>
                              <div className="flex items-center space-x-4 mt-1">
                                <div className="flex items-center space-x-1">
                                  <Calendar className="w-3 h-3 text-gray-400 dark:text-gray-500" />
                                  <span className="text-xs text-gray-500 dark:text-gray-400">{new Date(reminder.date).toLocaleDateString()}</span>
                                </div>
                                <div className="flex items-center space-x-1">
                                ...
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span className="text-xs text-gray-500 dark:text-gray-400 capitalize">{reminder.frequency}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">No reminders found</h3>
                  <p className="text-xl text-gray-600 dark:text-gray-400 mb-4">Create reminders to stay on track</p>
                  <button 
                    onClick={() => setShowAddModal(true)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Add New Reminder</h3>
              <button
